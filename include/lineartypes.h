...
#define UNIQ_LINEAR_NODE linearnode
#define UNIQ_LINEAR_CONTAINER linearcontainer
...
struct GENERATE_STRUCT_ID(UNIQ_LINEAR_NODE,val_type)
...
@param val_type: The data type contained by the node
*/
#define DeclareLinearContainer(val_type)\
LinearNodeType(val_type); \
struct GENERATE_STRUCT_ID(UNIQ_LINEAR_CONTAINER,val_type){\
...
@param val_type: The data type contained by the node
*/
#define LinearContainer(val_type, list_name) \
struct GENERATE_STRUCT_ID(UNIQ_LINEAR_CONTAINER,val_type) list_name={VOID_PTR, VOID_PTR, sizeof(val_type), 0}
